    ...
    return (
        <div className={styles.container} style={{ top: '20' }}>
            {isUpload ?
                ...
                <>
                    <h1 style={{ marginBottom: '30px' }}>upload image</h1><Space direction='vertical' size={40} align='center'>
                        <input
                            type="file"
                            accept="image/*"
                            onChange={handleImageChange} />
                        <button style={{ width: '120px' , backgroundColor:"#E9A99C"}} onClick={onSubmit}>upload</button>
